...
class TradingConfig(BaseModel):
    ...
    slippage_estimate_pct: float = 0.0005
...
class LLMConfig(BaseModel):
    ...
    openrouter_site_url: str = Field(default_factory=lambda: os.getenv("OPENROUTER_SITE_URL", "http://localhost"))
    openrouter_app_name: str = Field(default_factory=lambda: os.getenv("OPENROUTER_APP_NAME", "OrderFlowTrader"))
